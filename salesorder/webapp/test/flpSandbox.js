		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sales Order",
									"targetURL": "#comproductsalesorder-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comproductsalesorder-display": {
								"semanticObject": "comproductsalesorder",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.product.salesorder",
									"url": sap.ui.require.toUrl("com/product/salesorder")
								}
							}
						}
					}
